...
| Thành phần (Component) | Môi trường (Environment) | Đường dẫn (URL) |
| :--- | :--- | :--- |
| **Frontend Web App** | Vercel | [recruitment-management-system-ats.vercel.app](https://recruitment-management-system-ats.vercel.app) |
| **Backend REST API** | Render | [recruitment-management-system-ats.onrender.com](https://recruitment-management-system-ats.onrender.com/api/v1) |
| **Database** | Neon (PostgreSQL 16) | Serverless DB (Singapore) |

> 🔑 **Tài khoản dùng thử (Demo Credentials):**
> * **Admin (Toàn quyền):** `admin@example.com` / `password`
> * **Recruiter (Nhà tuyển dụng):** `recruiter@example.com` / `password`
> 
> *(Lưu ý: Do backend chạy ở gói Render Free, lượt truy cập đầu tiên có thể mất ~45s để server khởi động lại).*
...
> 
> *(Note: The backend runs on Render Free tier and may take ~45s to cold-start on initial request).*
