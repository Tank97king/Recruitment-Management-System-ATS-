...
const InterviewStatusModal = ({ open, currentStatus, onConfirm, onCancel, loading }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/55 animate-fadeIn">
      <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-xl relative border border-gray-100">
        ...
        <h3 className="font-bold text-gray-800 text-base mb-1">Update Interview Status</h3>
        <p className="text-xs text-gray-400 font-semibold mb-6 uppercase tracking-wider">Change interview status log</p>

        {isTerminal ? (
          <div className="space-y-4">
            <div className="p-4 bg-gray-50 border border-gray-200 rounded-xl text-xs font-semibold text-gray-500 text-center">
              This interview has already been processed ({currentStatus}) and cannot be transitioned further.
            </div>
